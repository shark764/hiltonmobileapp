...
class LoginOrSignupScreen extends Component {
	...
	render() {
		return (
			<SafeAreaView style={{ alignItems: 'center', flex: 1, margin: 16, justifyContent: 'space-evenly' }}>
				<Text
					style={{ fontFamily: fonts.OPENSANS_SEMI_BOLD, fontSize: 16, color: '#2F2F2F', marginVertical: 40 }}
				>

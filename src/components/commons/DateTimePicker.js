//Got from https://github.com/xgfe/react-native-datepicker
//But modified because some methods were deprecated
...
import Style from '../../assets/styles/dateTimePickerStyle';
...
class DatePicker extends Component {
	...
	render() {
		...
		return (
			<React.Fragment>
				{!!label && <Text style={[Style.label, customStyles.label]}>{label}</Text>}
				<TouchableComponent
				...
				{!!label && <Text style={[Style.errorMessage, customStyles.errorMessage]}>{errorMessage}</Text>}
			</React.Fragment>
		);
	}
}
